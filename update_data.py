...
#consulta da base existente com o objetivo de ler a ultima data preenchida.
     ...
     engine = create_engine("postgresql://postgres:Fiap123@localhost:5433/postgres")
     conn = engine.connect()
     ...
     if nova_data > ultima_data:
          engine = create_engine("postgresql://postgres:Fiap123@localhost:5432/postgres")  #não precisa
